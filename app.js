...
mongoose.connect("mongodb://localhost:27017/blognDB")
...
app.get("/posts/:postId",function(req,res){
  const requestedPostId = req.params.postId;
    ...
    var count=0;
      ...
      //  Here we are converting whatever case post.title and the parameter postTitle are in to lowercase so that we can compare them
